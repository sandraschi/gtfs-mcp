...
$backendCmd = "`$env:PYTHONPATH = '$srcPath;$PSScriptRoot'; Set-Location '$PSScriptRoot'; uv run uvicorn gtfs_mcp.server:app --host 127.0.0.1 --port $BackendPort --log-level info"
