...
async def get_stop_info(
    ...
    return {"success": True, "message": "Stop information retrieved successfully", "stop": stop_info}
...
async def get_departures(
    ...
    return {"success": True, "message": "Departures retrieved successfully", "departures": departures}
